...
public class CommentRdbmsRepositoryTest {
    ...
    public void saveACommentTest() {
        ...
        reviewRdbmsRepository.save(TestUtils.getReviews().get(0));

        Assert.assertEquals(TestUtils.getComments().get(0).getComment(),
                commentRdbmsRepository.save(TestUtils.getComments().get(0)).getComment());
    }
}
